...
export declare class StellarService {
     ...
     */
    submitTransactionWithRetries(builderFn: (sourceAccount: Account | Horizon.AccountResponse, currentFee: number) => Transaction, maxRetries: number, baseFee: number): Promise<any>;
    /**
